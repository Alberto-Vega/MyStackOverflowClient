...
+ (void) getRequestWithURL:(NSString * _Nonnull)url parameters:(NSDictionary* _Nonnull)parameters withCompletion:(kNSDataCompletionHandler _Nonnull)completionHandler;
